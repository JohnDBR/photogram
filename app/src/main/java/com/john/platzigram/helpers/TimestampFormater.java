package com.john.platzigram.helpers;
...
/**
 * Created by John on 6/27/2018.
 */

public class TimestampFormater {

    public static Date convertTimestampToDate(String oldDateString){
...
//        SimpleDateFormat newFormatter = new SimpleDateFormat("MMMM dd, yyyy 'at' HH:mm a");
//        String newDateString = newFormatter.format(date);
//        return newDateString;
        return date;
    }

    public static String convertTimestampToAgoString (String timestamp){
        Long timeNow = new Date().getTime();
        Long timeElapsed = Math.abs(timeNow - convertTimestampToDate(timestamp).getTime());
